...
namespace LibContract
{
    ...
    {
        public static double ClacHeightOfText(this XTextFormatterEx gr, XFont font, XRect layoutRectangle, string text)
        {
            double height = 0;
            int lastFettingChar = 0;
            gr.PrepareDrawString(text, font, layoutRectangle, out lastFettingChar, out height);
            return height;
        }
    }
