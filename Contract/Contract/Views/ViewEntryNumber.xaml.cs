...
namespace Contract.Views
{
    ...
    public partial class ViewEntryNumber : ContentView
    {
        ...
        {
            var control = (ViewEntryNumber)bindable;
            if (control != null)
        ...
        private static void MaskPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            var control = (ViewEntryNumber)bindable;
            if (control != null)
                control.entryMask.Mask = (string)newValue;
        }
        #endregion
        ...
        #region TextChanged
        public static readonly BindableProperty CommandProperty = BindableProperty.Create("Command", typeof(ICommand), typeof(ViewEntryNumber), null);
        public static readonly BindableProperty CommandParameterProperty = BindableProperty.Create("CommandParameter", typeof(object), typeof(ViewEntryNumber), null);
